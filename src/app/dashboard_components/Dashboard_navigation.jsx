...
function Dashboard_navigation() {
  ...
  return (
    <nav className="opacity-80 hover:opacity-100 bg-white shadow-2xl hidden md:block group h-screen border-r-2 border-darkbrown w-[85px] hover:w-[290px] transition-all duration-200 ease-in-out absolute top-22.5 left-0">
