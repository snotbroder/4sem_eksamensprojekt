...
function Dashboard_navigation() {
  return (
    <nav className="hidden md:block group h-screen border-r-2 border-darkbrown w-[100px] hover:w-[290px] transition-all duration-200 ease-in-out overflow-hidden">
      <ul className="flex flex-col gap-xs py-xl items-start pl-4">
