...
export default function About() {
  return (
    <div>
      <section className=" mt-[10vh]  px-s lg:px-6xl grid gap-sm lg:gap-xl  lg:grid-cols-2 lg:items-start mb-3xl lg:mb-6xl">
        ...
        <div>
          <Animation>
            <article className=" relative h-[50vh] lg:h-[185vh] transition-all ease-in-out ">
              <Image data-aos="zoom-out" src="/Image_bank/aboutus/fire.png" alt="making food and it spews" width={162} height={250} className="absolute -top-1 right-0 lg:w-[200px] lg:h-[290px] lg:object-cover" />
              <Image data-aos="zoom-out" src="/Image_bank/aboutus/interior2.png" alt="discolight" width={220} height={200} className="absolute top-1/3 left-1/4 translate-[-50%]" />
              <Image data-aos="zoom-out" src="/Image_bank/aboutus/lamarrules.svg" alt="lamar rules" width={309} height={246} className="place-self-center relative top-2xl z-50" />

              <Image data-aos="zoom-out" src="/Image_bank/aboutus/food1.png" alt="plates of food" width={162} height={200} className="absolute bottom-0 lg:left-xl" />
              <Image data-aos="zoom-out" src="/Image_bank/aboutus/team1.png" alt="bunch of polaroids of the workteam on a fridge" width={152} height={207} className="absolute bottom-xs lg:bottom-1/6 right-1/4 translate-x-[50%]" />
              <Image data-aos="zoom-out" src="/Image_bank/aboutus/interior1.png" alt="red interior" width={152} height={207} className=" absolute left-1/2 top-1/2 translate-[-50%] lg:w-[250px] lg:left-0 lg:translate-x-0 z-0" />
              <Image data-aos="zoom-out" src="/Image_bank/aboutus/interior3.png" alt="poster of a basketbal player" width={172} height={237} className="absolute bottom-1/4 hidden lg:block right-0 " />
            </article>
          </Animation>
        </div>
      </section>
