          ...
          <Animation>
            <article className=" relative h-[50vh] lg:h-[185vh] transition-all ease-in-out ">
              ...
              <Image
                ...
                width={220}
                height={200}
                className="absolute top-1/3 left-1/4 translate-[-50%]"
              />
              <Image
                data-aos="zoom-out"
                ...
                width={309}
                height={246}
                className="place-self-center relative top-2xl z-50"
              />
              ...
              <Image
                ...
                width={152}
                height={207}
                className=" absolute left-1/2 top-1/2 translate-[-50%] lg:w-[250px] lg:left-0 lg:translate-x-0 z-0"
              />
              <Image
                data-aos="zoom-out"
                ...
                width={172}
                height={237}
                className="absolute bottom-1/4 hidden lg:block right-0 "
              />
            </article>
          </Animation>
        </div>
