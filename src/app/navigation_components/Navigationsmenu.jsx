  ...
  return (
    <div className="border-b border-darkbrown backdrop-blur-2xl sticky top-0 z-[1000] bg-[url('/Image_bank/illustrations/layerblur.png')] bg-cover bg-center">
      ...
      {showMenu && (
        <div
          ref={menuRef}
          className=" backdrop-blur-2xl fixed top-[88px] left-0 w-full lg:hidden grid gap-ml bg-[url('/Image_bank/illustrations/lamarbuilding-burgermenu.svg')] bg-cover bg-center z-[1000] border-b border-darkbrown "
        >
