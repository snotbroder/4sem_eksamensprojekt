    ...
    <section className="mx-s md:mx-6xl">
      ...
      <article className="flex flex-wrap ">
        <SisterCard
          ...
          description={
            "Kima is our locally rooted, buzzing and cheeky little sister. It's colorful and high-spirited here – both physically and spiritually. We cook food from all corners of the world and serve wine with and without added sulfur and love to guide and talk about wine. Beers on tap, drinks and frothy non-alcoholic alternatives too.."
          }
        ...
        <SisterCard
          ...
          description={
            "Our cozy modern Italian in Nørrebro, a stone's throw from the lakes. Dive headfirst into pasta, crostini, polenta, risotto and antipasti. The lights are turned down and the sound of the 90s golden age of hip hop and some detours to some of the recent decades are turned up."
          }
          bgcolor={"primary-200"}
